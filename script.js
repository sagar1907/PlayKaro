...
let shuffle=()=>{
    ...
    for(let i=0;i<arr.length;i++){
        newarr[i]=arr[Math.floor(Math.random() * 10)];
    }
    //console.log(newarr);
    return newarr;
}
...
let normalArray=document.getElementsByClassName('songItemPlay');
...
Array.from(flag?normalArray:shuffleArray).forEach((element)=>{
